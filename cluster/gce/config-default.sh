...
OS_DISTRIBUTION=${KUBE_OS_DISTRIBUTION:-coreos}
MASTER_IMAGE=${KUBE_GCE_MASTER_IMAGE:-container-vm-v20150317}
MASTER_IMAGE_PROJECT=${KUBE_GCE_MASTER_PROJECT:-google-containers}
MINION_IMAGE=${KUBE_GCE_MINION_IMAGE:-coreos-alpha-668-2-0-v20150430}
MINION_IMAGE_PROJECT=${KUBE_GCE_MINION_PROJECT:-coreos-cloud}
CONTAINER_RUNTIME=${KUBE_CONTAINER_RUNTIME:-rkt}

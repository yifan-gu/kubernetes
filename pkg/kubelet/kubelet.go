...
func NewMainKubelet(
	...
	containerManager := dockertools.NewDockerManager(dockerClient, recorder, readinessManager, podInfraContainerImage, pullQPS, pullBurst)
...
func (kl *Kubelet) syncPod(pod *api.Pod, mirrorPod *api.Pod, runningPod kubecontainer.Pod) error {
	...
	containerChanges, err := kl.containerManager.ComputePodContainerChanges(pod, runningPod, podStatus, kl.prober)

...
func New(config *Config,
	...
	if err != nil {
		return nil, fmt.Errorf("rkt: cannot connect to dbus: %v", err)
	}
	...
	if err := rkt.checkVersion(minimumRktBinVersion, recommendRktBinVersion, minimumAppcVersion, minimumRktApiVersion); err != nil {
